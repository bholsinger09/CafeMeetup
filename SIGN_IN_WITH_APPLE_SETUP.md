...
- Look for App ID: **com.Ben.CafeMeetup**
- If it doesn't exist, create it:
  - Click the **+** button
  - Select **App IDs**
  - Select **App** type
  - Enter Description: "CafeMeetup"
  - Bundle ID: **com.Ben.CafeMeetup** (Explicit)

### 3. Enable Sign in with Apple Capability
- Select your App ID (com.Ben.CafeMeetup)
- Click **Edit**
...
- Verify Bundle Identifier: **com.Ben.CafeMeetup**
...
- Check that your app's bundle ID matches exactly: com.Ben.CafeMeetup
