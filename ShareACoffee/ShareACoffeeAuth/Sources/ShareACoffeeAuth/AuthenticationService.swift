...
public class AuthenticationService: AuthenticationServiceProtocol {
    nonisolated(unsafe) public static let shared = AuthenticationService()
    ...
    private func initializeReviewerAccount() {
        ...
        let reviewerUser = User(
            ...
            gender: "Female",
            location: User.Location(latitude: 43.6150, longitude: -116.2023), // Boise, ID
            profileImageURL: nil,
            lastActiveAt: Date(),
            createdAt: Date(),
            updatedAt: Date(),
    ...
    private func initializeSampleUsers() {
        ...
        let sampleUsers: [User] = [
            User(
                ...
                gender: "Male",
                location: User.Location(latitude: 43.6187, longitude: -116.2146),
                profileImageURL: nil,
                lastActiveAt: Date(),
            ...
            User(
                ...
                gender: "Female",
                location: User.Location(latitude: 43.6202, longitude: -116.2034),
                profileImageURL: nil,
                lastActiveAt: Date(),
                major: "Biology",
                graduationYear: 2025,
            ...
            User(
                ...
                gender: "Male",
                location: User.Location(latitude: 43.6125, longitude: -116.1985),
                profileImageURL: nil,
                lastActiveAt: Date(),
    ...
    public func signUp(email: String, password: String, user: User) async throws -> User {
    ...
    public func signInWithApple(userID: String, email: String, fullName: String?) async throws -> User {
